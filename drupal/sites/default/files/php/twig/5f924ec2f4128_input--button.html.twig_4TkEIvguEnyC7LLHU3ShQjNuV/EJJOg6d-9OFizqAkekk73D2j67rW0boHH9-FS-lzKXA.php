...
class __TwigTemplate_49cfe3ad2533bd133f0e4fe44ef447fcae73a893ea9179cce4ffab57d28c93be extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["icon"] ?? null) && ($context["icon_position"] ?? null)) &&  !($context["icon_only"] ?? null))) ? (("icon-" . $this->sandbox->ensureToStringAllowed(($context["icon_position"] ?? null), 30, $this->source))) : (""))];
  ...
  ";
    ...
    {
        return new Source("", "themes/bootstrap/templates/input/input--button.html.twig", "/Applications/MAMP/www/IT7744/module4/drupal/themes/bootstrap/templates/input/input--button.html.twig");
    }
}
